<section id="sortfilter">
    ...
    <div class="boxfilter mt-3">
        <form action="" method="POST" enctype="multipart/form-data"  id="searchForm">
            @csrf
            @php
                $data_type = ['country' => array(),'city' => array(),'day' => array(),'price' => array(),'airline' => array(),'rating' => array(),'month_fil' => array(),'calen_start' => array(),'start_date' => array(),'end_date' => array()];
            @endphp
             ...
             <input type="hidden" name="travel_id" id="travel_id_data" value="{{json_encode($travel_id)}}">
             <div class="titletopic">
           ...
           <div id="hide_month"> 
            ...
            <div class="filtermenu">
                ...
                <ul id="show_country">
                    ...
                    @endif
                    {{-- @if(count($data_country) > 3)<a data-bs-toggle="collapse" data-bs-target="#morecountry" class="seemore"> ดูเพิ่มเติม</a>@endif --}}
                </ul>
            </div>
            ...
            @if($filter)
                ...
                <div class="filtermenu">
                    ...
                    <li><label class="check-container" hidden> ทั้งหมด
