    ...
    <div class="d-none d-sm-none d-md-none d-lg-block d-xl-block">
        ...
        <div class="boxfilter mt-3">
                ...
                <div class="col-lg-12" id="hide_date" style="margin-top:20px;">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="hidden" name="start_date" id="s_date" @if($search_start) value="{{$search_start}}" @endif/>
                                <input type="hidden" name="end_date" id="e_date"  @if($search_end) value="{{$search_end}}" @endif />
                    ...
                    {{-- <div class="filtermenu" id="hide_date" >
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6">
                                    <p style="text-align:left;">วันไป</p>
                                    <input type="date" class="form-control" @if(@$search_start) value="{{$search_start}}" @endif name="start_date" min="{{date('Y-m-d')}}" id="s_date" onchange="Check_filter(this.value,'start_date')">
                                    @php
                                        $data_type['start_date'][] = $search_start;
                                    @endphp
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <input type="date" class="form-control" @if(@$search_end) value="{{$search_end}}" @endif  name="end_date" min="{{date('Y-m-d')}}" id="e_date" onchange="Check_filter(this.value,'end_date')">
                                    @php
                                        $data_type['end_date'][] = $search_end;
                                    @endphp
                                </div>
                ...
                <div class="filtermenu">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="ชื่ออำเภอ" name="city_search" id="city_search"  aria-label="air"
                            ...
                            @foreach ($data_city as $n => $coun)
                                @if($n <= 9)
                                    @foreach ($coun as $c)
                                        @php
                                            $data_type['city'][] = $c;
                                            $tour = App\Models\Backend\TourModel::whereIn('id',$t_id)->where('district_id','like','%"'.$c->id.'"%')/* ->where('status','on')->where('deleted_at',null) */;
                                            // ราคาถูกสุด
                                            if($orderby_data == 1){
                                        ...
                                        @endphp
                                        {{-- @if($n <= 3) --}}
                                        <li><label class="check-container"> {{$c->name_th?$c->name_th:$c->name_en}}
                                    ...
                                    <div id="moreprovince" class="collapse">
                                        @foreach ($coun as $c)
                                            @php
                                                ...
                                                $city_num[$c->id] = $tour;
                                            @endphp
                                            <li><label class="check-container">  {{$c->name_th?$c->name_th:$c->city_name_en}}
            ...
            <div class="offcanvas-body small">
                <div class="boxfilter">
                        ...
                        <div class="col-lg-12" id="hide_date_mb"  style="margin-top:20px;">
                            ...
                            {{-- <div class="filtermenu" id="hide_date_mb" hidden>
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <p style="text-align:left;">วันไป</p>
                            ...
                            <ul  id="show_city_mb">
                                @php
                                    ...
                                    foreach ($city_mb as $re) {
                                        $data_city_mb[] = App\Models\Backend\AmupurModel::where('id',$re)->get(); 
                                    }
                                @endphp
