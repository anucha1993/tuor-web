                            ...
                            <div class="intro-y box p-5">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <select class="form-control  w-full" name="_id" id="_id" disabled>
                                            <option value="" hidden>กรุณาเลือก</option>
                                            @if(@$main)
                                            @foreach($main as $i => $c)
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="icon" name="icon" placeholder="กรุณากรอกชื่อ Icon ตามลิงค์ด้านบน" aria-describedby="input-group-3">
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <input type="text" id="url" name="url" class="form-control w-full" placeholder="Input text">
                                    </div>
                                </div>
