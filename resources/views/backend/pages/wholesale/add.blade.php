                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <input type="text" id="wholesale_name_th" name="wholesale_name_th" class="form-control" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อภาษาอังกฤษ</label>
                                        <input type="text" id="wholesale_name_en" name="wholesale_name_en" class="form-control" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                  ...
                                  <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <input type="text" id="textid" name="textid"  class="form-control">
                                    </div>
                                </div>
