...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <h2 class="intro-y text-lg font-medium mt-10">ข้อมูลข่าวสาร</h2>
            
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" class="form-control w-56 box pr-10 myLike" name="name" placeholder="ค้นหาหัวข้อข่าว">
                        <i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0" data-lucide="search"></i>
                    </div>
                </div>
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <select name="type"  class="form-control w-56 box pr-10 myLike">
                            <option value="" hidden>ประเภทข่าวสาร</option>
                            @foreach ($type as $t)
            ...
            $(function () {
                oTable = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'title',
                            title: '<center>หัวข้อข่าว</center>',
                            className: 'whitespace-nowrap w-40 text-center'
                        }, // 2
                        {
                            data: 'type',
                            title: '<center>ประเภทข่าว</center>',
