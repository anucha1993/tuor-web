                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-4">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพ Logo <span class="text-danger"> ขนาด 65*18</span></h6>
                                        <img src="@if(@$row->image == null) {{url("noimage.jpg")}} @else {{asset($row->image)}} @endif"
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-4">
                                        <label for="crud-form-1" class="form-label">รหัสการเดินทาง (IATA)</label>
                                        <input type="text" name="code" id="code" class="form-control" value="{{$row->code}}">
                                    </div>
                                    <div class="col-span-12 lg:col-span-4">
                                        <label for="crud-form-1" class="form-label">รหัสการเดินทาง (ICAO)</label>
                                        <input type="text" name="code1" id="code1" class="form-control" value="{{$row->code1}}">
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-8">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ประเภทการเดินทาง</label>
                                        <input type="text" name="travel_name" id="travel_name" class="form-control" value="{{$row->travel_name}}">
                                    </div>
                                </div>
