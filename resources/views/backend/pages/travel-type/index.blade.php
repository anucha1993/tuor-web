...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <h2 class="intro-y text-lg font-medium mt-10">เที่ยวบินและการเดินทาง</h2>
            
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" class="form-control w-56 box pr-10 myLike" name="search_code" placeholder="ค้นหารหัสการเดินทาง">
                        <i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0" data-lucide="search"></i>
                    </div>
                </div>
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" class="form-control w-56 box pr-10 myLike" name="search_name" placeholder="ค้นหาประเภทการเดินทาง">
                        <i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0" data-lucide="search"></i>
                    </div>
                </div>
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
            ...
            $(function () {
                oTable = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'img',
                            title: '<center>โลโก้</center>',
                            className: 'items-center justify-center'
                        }, //1
                        {
                            data: 'code',
                            title: '<center>รหัสการเดินทาง</center>',
                            className: 'whitespace-nowrap w-30 text-center'
                        }, // 2
                        {
                            data: 'travel_name',
                            title: '<center>ประเภทการเดินทาง</center>',
                            className: 'whitespace-nowrap w-30 text-center'
                        }, // 3
                        {
                            data: 'status',
                            title: '<center>สถานะ</center>',
                            className: 'items-center w-30 text-center'
                        }, // 4
                        {
                            data: 'updated_at',
                            title: '<center>วันที่อัพเดท</center>',
                            className: 'whitespace-nowrap w-30 text-center'
                        }, // 5
                        {
                            data: 'action',
