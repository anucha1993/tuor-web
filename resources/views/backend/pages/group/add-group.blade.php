                            ...
                            <div class="intro-y box p-5 place-content-center">
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพปก <span class="text-danger">ขนาด 543*293 </span></h6>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
                                        <label for="crud-form-1" class="form-label">กรุ๊ปทัวร์</label>
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <a class="btn btn-outline-danger w-24 mr-1" href="{{ url("$segment/$folder/$id") }}" >ยกเลิก</a>
                                </div>
                            </div>
                            <!-- END: Form Layout -->
                        </div>
