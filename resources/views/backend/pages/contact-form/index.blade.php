...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <h2 class="intro-y text-lg font-medium mt-10">แบบฟอร์มติดต่อสอบถาม</h2>
            
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" class="form-control w-56 box pr-10 myLike" name="name" placeholder="ค้นหาชื่อ-นามสกุลหรือบริษัท">
            ...
            $(function () {
                oTable = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'surname',
                            title: '<center>นามสกุล</center>',
                            className: 'whitespace-nowrap w-40 text-center'
                        }, // 1
                        {
                            data: 'company',
                            title: '<center>บริษัท</center>',
