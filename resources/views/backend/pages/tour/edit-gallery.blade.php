...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <form id="menuForm" method="post" action="{{url('webpanel/tour/edit-gallery/'.$id)}}" enctype="multipart/form-data" >
                @csrf
                        ...
                        <div class="intro-y col-span-12 lg:col-span-6">
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <a class="btn btn-outline-danger w-24 mr-1" href="{{ url("$segment/$folder/edit/".$tour_id) }}" >ยกเลิก</a>
                                </div>
                            </div>
                            <!-- END: Form Layout -->
                        </div>
