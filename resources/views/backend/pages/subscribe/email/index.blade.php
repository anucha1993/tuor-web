...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <h2 class="intro-y text-lg font-medium mt-10">ฟอร์มส่งข้อมูล</h2>
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ประเภทการส่งข้อความ</label>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>รายละเอียด</label>

                                        <textarea id="message" name="message" class="form-control tiny" rows="15"></textarea>
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <button type="submit" class="btn btn-primary w-24">ส่งเมล</button>
