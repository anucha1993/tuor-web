                            ...
                            <div class="intro-y box p-5 place-content-center">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <select name="country_id" id="country_id" class="form-control select2" required>
                                            ...
                                            @foreach ($country as $c)
                                                <option value="{{$c->id}}" @if($row->country_id == $c->id) selected @endif>{{$c->country_name_th}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <input type="text" id="city_name_th" name="city_name_th" value="{{ $row->city_name_th }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อภาษาอังกฤษ</label>
                                        <input type="text" id="city_name_en" name="city_name_en" value="{{ $row->city_name_en }}" class="form-control" required>
                                    </div>
                                </div>
