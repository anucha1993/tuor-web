...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3">รูปภาพ(ซ้าย) <span class="text-danger">ขนาด 960*501 </span></h6>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3">รูปภาพ(ขวา) <span class="text-danger">ขนาด 960*501 </span></h6>
            ...
            <!-- END: Content -->
            <h2 class="intro-y text-lg font-medium mt-10">ข้อมูลใบอนุญาต</h2>
            <br>
            <div class="intro-y box p-5 place-content-center">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <div class="hidden md:block mx-auto text-slate-500"></div>
                    <div class="float-right">
                        <a href="{{ url("$segment/$folder/add-licens") }}" class="btn btn-primary shadow-md mr-2">เพิ่มข้อมูล</a>
                    </div>
                </div>
                <br>
                <div class="overflow-x-auto"  style="background-color: #F5F5F5;padding:15px;border-radius:5px;">
                    <table id="datatable-licens" class="table table-report"></table>
                </div>
                <!-- DATA TABLE -->
            </div>
            <h2 class="intro-y text-lg font-medium mt-10">อัลบั้มรูปรางวัล</h2>
            <br>
            <div class="intro-y box p-5 place-content-center">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <div class="hidden md:block mx-auto text-slate-500"></div>
                    <div class="float-right">
                        <a href="{{ url("$segment/$folder/add-gallery") }}" class="btn btn-primary shadow-md mr-2">เพิ่มข้อมูล</a>
                    </div>
                </div>
                <br>
                <div class="overflow-x-auto"  style="background-color: #F5F5F5;padding:15px;border-radius:5px;">
        ...
        <script>
            var id = "{{$id}}";
            var fullUrl = "{{url('webpanel/about-us')}}";
            var oTable;
            ...
            $(function () {
                oTable = $('#datatable-licens').DataTable({
                    searching: false,
                    ordering: false,
                    lengthChange: false,
                    pageLength: 10,
                    ...
                    iDisplayLength: 25,
                    ajax: {
                        url: fullUrl+"/"+id+"/datatable-licens?_token="+_token,
                        data: function (d) {
                            d.Like = {};
                            $('.myLike').each(function () {
                                if ($.trim($(this).val()) && $.trim($(this).val()) != '0') {
            ...
            function destroyLicens(id) {
                Swal.fire({
                    ...
                    showLoaderOnConfirm: true,
                    preConfirm: () => {
                        return fetch(fullUrl + '/destroy-licens/' + id)
                            .then(response => response.json())
                            .then(data => location.reload())
                            .catch(error => {
                                Swal.showValidationMessage(`Request failed: ${error}`)
