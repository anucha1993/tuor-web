                            ...
                            <div class="intro-y box p-5">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                    <div class="col-span-6 lg:col-span-6">
                                        ...
                                        <input class="form-control" id="name" type="text" name="name" placeholder="ชื่อ" autocomplete="off">
                                    </div>
                                    <div class="col-span-6 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">นามสกุล</label>
                                        <input class="form-control" id="surname" type="text" name="surname" placeholder="นามสกุล" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                    <div class="col-span-6 lg:col-span-6">
                                        ...
                                        <input class="form-control" id="phone" type="text" name="phone" placeholder="เบอร์โทรศัพท์" autocomplete="off">
                                    </div>
                                    <div class="col-span-6 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">อีเมล</label>
                                        <input class="form-control" id="email" type="email" name="email" placeholder="อีเมล" autocomplete="off">
                                    </div>
                                </div>
