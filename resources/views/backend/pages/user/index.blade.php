            ...
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="{{ url("$segment/$folder/add") }}"><button type="button"
                            class="btn btn-primary shadow-md mr-2">เพิ่มข้อมูล</button></a>
                </div>
            </div>
        ...
        function getdatatable(){
            new Tabulator("#datatable_01", {
                ...
                columns:[
                    ...
                    {field: 'action_name',   title :'<center>ชื่อ</center>', vertAlign:"middle" , formatter:"html",  width:'25%'}, // 1
                    {field: 'action_username',   title :'<center>ชื่อผู้ใช้งาน</center>', vertAlign:"middle" , formatter:"html",  width:'15%'}, // 1
                    {field: 'action_role',   title :'<center>บทบาทหน้าที่</center>', vertAlign:"middle" , formatter:"html",  width:'15%'}, // 1
                    {field: 'created',    title :'วันที่สร้าง', formatter:"html", vertAlign:"middle", align:"center", width:'10%'}, // 3
                    {field: 'status',    title :'สถานะ', formatter:"html", vertAlign:"middle", align:"center",    width:'10%'}, // 4
                    {field: 'action',    title :'จัดการ', formatter:"html", vertAlign:"middle", align:"center",    width:'20%'}, // 5
                ],
