...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <h2 class="intro-y text-lg font-medium mt-10">แบนเนอร์โฆษณา</h2>
                <form method="post" action="{{url('webpanel/banner-ads/edit-status')}}" enctype="multipart/form-data">
                @csrf
                    <div class="intro-y col-span-12 flex flex-wrap items-center mt-2">
                        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                            <div class="w-full sm:w-auto mt-2 mr-2 sm:mt-0 sm:ml-auto md:ml-0 mb-2 sm-mb-1" >
                                ...
                                <input type="number" value="{{$row->time_ads}}" min="1" max="9999" name="time" class="form-control w-56 box  sm:w-20">
                            </div>
                            <div class="w-full sm:w-auto mt-2 mr-2 sm:mt-0 sm:ml-auto md:ml-0 mb-2 sm-mb-1">
                                ...
                                <select name="slide" class="form-select w-full sm:w-20">
                                    <option value="on" @if($row->status_ads == 'on') selected @endif>เปิด</option>
                                    <option value="off" @if($row->status_ads == 'off') selected @endif>ปิด</option>
                                </select>
                            </div>
                        </div>
                        <div class="w-full sm:w-auto mt-2 mr-2 sm:mt-0 sm:ml-auto md:ml-0 mb-2 sm-mb-1">
