                            ...
                            <div class="intro-y box p-5 place-content-center">
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-2">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปแท็ก <span class="text-danger">ขนาด 65*65 </span></h6>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-8">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อแท็ก</label>
                                        <input type="text" name="tag" id="tag" class="form-control" value="{{$row->tag}}">
                                    </div>
                                </div>
