            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" class="form-control w-56 box pr-10 myLike" name="search_name" placeholder="ค้นหาชื่อประเภททัวร์">
            ...
            $(function () {
                oTable = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {  data: 'image',      title: '<center>รูปภาพ</center>',     className: 'items-center w-20 text-center'},
                        {  data: 'type_name',      title: '<center>ประเภททัวร์</center>',     className: 'items-center w-20 text-center'},
