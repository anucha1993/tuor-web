                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพ <span class="text-danger"> ขนาด 52*52</span></h6>
                                        <img src="@if(@$row->image == null) {{url("noimage.jpg")}} @else {{asset($row->image)}} @endif" class="img-thumbnail" id="preview" style="width:51px; height:51px;">
                                    </div>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อประเภททัวร์</label>
                                        <input type="text" id="type_name" name="type_name" value="{{ $row->type_name }}" class="form-control" required>
                                    </div>
                                </div>
