    ...
    <div class="flex">
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพปก <span class="text-danger"> ขนาด 736*407</span></h6>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ประเภทบทความ</label>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        {{-- <input type="text" id="input-tag" name="input_tag[]" placeholder="Enter tag name"  />
                                        <a class="btn btn-outline-danger w-24 mr-1" href="javascript:void(0)" onclick="SaveTag()" >บันทึก</a>
        ...
        <script>
            ...
            function check_add() {
                ...
                if (image == "" || type_id == "" || title == "" || country_id == "") {
