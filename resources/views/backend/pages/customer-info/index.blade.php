...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <h2 class="intro-y text-lg font-medium mt-10">ข้อมูลลูกค้าของเรา</h2>
                <form method="post" action="{{url('webpanel/customer-info/edit-status')}}" enctype="multipart/form-data">
                @csrf
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                            <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0" >
                                ...
                                <input type="number" value="{{$row->time_cus}}" min="1" max="9999" name="time" class="form-control w-56 box  sm:w-20">
                            </div>
                            <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                ...
                                <select name="slide" class="form-select w-full sm:w-20">
                                    <option value="on" @if($row->status_cus == 'on') selected @endif>เปิด</option>
                                    <option value="off" @if($row->status_cus == 'off') selected @endif>ปิด</option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <select class="form-control w-56 box pr-10 select2 myLike" name="country"  >
                            <option value="0">ค้นหาประเทศที่เดินทาง</option>
                ...
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <select name="type_customer" class="form-control w-56 box pr-10 select2 myLike">
                            <option value="" >ค้นหาประเภทลูกค้า</option>
                            @foreach($type as $t)
            ...
            $(function () {
                oTable = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: 'company',
                            title: '<center>ชื่อลูกค้า/บริษัท</center>',
                            className: 'whitespace-nowrap w-30 text-center'
                        }, // 1
                        {
                            data: 'country',
                            title: '<center>ประเทศที่เดินทาง</center>',
                            className: 'whitespace-nowrap w-30 text-center'
                        }, // 2
                        {
                            data: 'type',
                            title: '<center>ประเภทลูกค้า</center>',
                            className: 'whitespace-nowrap w-30 text-center'
                        }, // 2
                        {
                            data: 'status',
