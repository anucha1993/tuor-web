...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <form id="menuForm" method="post" action="{{url('webpanel/customer-info/edit-gallery/'.$id)}}" enctype="multipart/form-data" >
                @csrf
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพ</h6>
                                ...
                                <div class="text-center mt-5">
                                    ...
                                    <a class="btn btn-outline-danger w-24 mr-1" href="{{ url("$segment/$folder/".$cus_id) }}" >ยกเลิก</a>
                                </div>
                            </div>
                            <!-- END: Form Layout -->
                        </div>
        ...
        <script>
            ...
            CKEDITOR.replace('subtitle_th', {
                filebrowserUploadMethod: 'form',
            });
            CKEDITOR.replace('subtitle_en', {
                filebrowserUploadMethod: 'form',
            });
