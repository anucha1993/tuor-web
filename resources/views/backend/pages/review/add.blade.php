                            ...
                            <div class="intro-y box p-5 place-content-center">
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพ <span class="text-danger">ขนาด 546*366 </span></h6>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-4">
                                        <h6 class="mb-3">รูปโปรไฟล์ลูกค้า</h6>
                                        <img src="@if(@$row->profile == null) {{url("noimage.jpg")}} @else {{asset($row->profile)}} @endif"
                                            class="img-thumbnail" id="preview-profile">
                                    </div>
                                    <div class="col-span-12 lg:col-span-12">
                                        <small class="help-block">* รองรับไฟล์ <strong class="text-danger">(jpg, jpeg,
                                                png)</strong> เท่านั้น</small>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-6 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">ประเทศ/เมืองที่เดินทาง</label>
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">ชื่อทริป</label>
                                        <input type="text" name="trip" class="form-control">
                                    </div>
                                </div>
                                {{-- <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">ประเทศที่เดินทาง</label>
                                        <select data-placeholder="กรุณาเลือกข้อมูล" class="tom-select w-full" multiple name="country_id[]" >
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อลูกค้า</label>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <textarea name="detail" id="detail" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
        ...
        <script>
            ...
            $("#profile").on('change', function () {
                ...
                if (input.files && input.files[0]) {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        $('#preview-profile').attr('src', e.target.result).fadeIn('fast');
                    }
                    reader.readAsDataURL(input.files[0]);
                }
            });
