    ...
    <div class="flex">
                    ...
                    <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
                        <div class="intro-y col-span-12 lg:col-span-12">
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <h6 class="mb-3"><span class="text-danger">*</span>รูปภาพธง <span class="text-danger"> ขนาด 150*100</span></h6>
                                    ...
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <div class="col-span-6 lg:col-span-6">
                                            <input type="file" class="custom-file-input block w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                                name="img_icon" id="img_icon" accept="image/png, image/jpeg, image/jpg, image/svg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    ...
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <div class="col-span-6 lg:col-span-6">
                                            <input type="file" class="custom-file-input block w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                                name="img_banner" id="img_banner" accept="image/png, image/jpeg, image/jpg">
                                        </div>
                                    </div>
                                </div>
                                {{-- image --}}
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <input type="text" id="country_name_th" name="country_name_th" value="{{ $row->country_name_th }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อภาษาอังกฤษ</label>
                                        <input type="text" id="country_name_en" name="country_name_en" value="{{ $row->country_name_en }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">รหัสประเทศ (ISO2)</label>
                                        <input type="text" id="iso2" name="iso2" value="{{ $row->iso2 }}" class="form-control">
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">รหัสประเทศ (ISO3)</label>
                                        <input type="text" id="iso3" name="iso3" value="{{ $row->iso3 }}" class="form-control">
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label">คำอธิบาย(หน้าหลัก)</label>
                                        <textarea  name="description"  class="tiny">{{ $row->description }}</textarea>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function check_add() {
                ...
                if (landmass_id == "" || country_name_th == "" || country_name_en == "") {
