                        ...
                        <div class="intro-y box p-5">
                            ...
                            <div class="row mt-2">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-check form-switch mb-3" dir="ltr">
                                        <input type="checkbox" class="form-check-input" id="status_form" name="status_form" @if($row->status == "on") checked @endif>
                                        <label class="form-check-label" for="status_form">ใช้งาน</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-right mt-5">
                                <a class="btn btn-outline-secondary w-24 mr-1"
                                    href="{{ url("$segment/$folder") }}">ยกเลิก</a>
