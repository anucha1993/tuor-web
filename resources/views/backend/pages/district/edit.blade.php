    ...
    <div class="flex">
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>จังหวัด</label>
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        ...
                                        <input type="text" id="name_th" name="name_th" value="{{ $row->name_th }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-6">
                                        <label for="crud-form-1" class="form-label"><span class="text-danger">*</span>ชื่อภาษาอังกฤษ</label>
                                        <input type="text" id="name_en" name="name_en" value="{{ $row->name_en }}" class="form-control" required>
                                    </div>
                                </div>
        ...
        <script>
            function check_add() {
                ...
                if (province_id == "" || name_th == "" || name_en == "") {
