            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" class="form-control w-56 box pr-10 myLike" name="search_name" placeholder="ค้นหาชื่ออำเภอ">
                        <i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0" data-lucide="search"></i>
                    </div>
                </div>
                <div class="w-full sm:w-auto mt-3 mr-2 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <select name="search_province" class="form-control w-56 box pr-10 select2 myLike">
            ...
            $(function () {
                oTable = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        {  data: 'province_id',      title: '<center>จังหวัด</center>',     className: 'items-center w-20 text-center'},
                        {  data: 'name_th',      title: '<center>ชื่อ</center>',     className: 'items-center w-20 text-center'},
                        {  data: 'name_en',      title: '<center>ชื่อ</center>',     className: 'items-center w-20 text-center'},
            ...
            function destroy(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: '{{ url("/webpanel/district/delete") }}',
                            data: {
                                id:id,
                                _token:"{{ csrf_token() }}"
                            },
