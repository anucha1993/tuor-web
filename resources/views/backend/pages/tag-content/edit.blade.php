...
<body class="py-5">
    ...
    <div class="flex">
        ...
        <div class="content">
            ...
            <form id="menuForm" method="post" action="{{url('webpanel/tag-content/edit/'.$id)}}" enctype="multipart/form-data" >
                @csrf
                            ...
                            <div class="intro-y box p-5 place-content-center">
                                <div class="grid grid-cols-12 gap-6 mt-3 mb-3">
                                    <div class="col-span-12 lg:col-span-12">
                                        ...
                                        <input type="text" id="tag" name="tag" class="form-control" value="{{$row->tag}}">
                                    </div>
                                </div>
