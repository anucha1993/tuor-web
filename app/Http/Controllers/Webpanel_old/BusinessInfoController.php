...
class BusinessInfoController extends Controller
{
    ...
    protected $controller = 'business-info';
    protected $folder = 'business-info';
    protected $menu_id = '14';
    protected $name_page = "ข้อมูลธุรกิจหลักของบริษัท";
    ...
    public function index(Request $request)
    {
        ...
        $navs = [
            '1' => ['url' => "$this->segment/$this->folder", 'name' => "ข้อมูลธุรกิจหลักของบริษัท", "last" => 0],
        ];
    ...
    {
        $like = $request->Like;
        $sTable = BusinessModel::orderby('id', 'asc')
    ...
    {
        $datas = BusinessModel::find($id);
        if (@$datas) {
            $query = BusinessModel::destroy($datas->id);
        }
