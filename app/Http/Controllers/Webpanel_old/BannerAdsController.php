...
class BannerAdsController extends Controller
{
    ...
    protected $controller = 'banner-ads';
    protected $folder = 'banner-ads';
    protected $menu_id = '33';
    protected $name_page = "แบนเนอร์โฆษณา";
    ...
    public function index(Request $request)
    {
        ...
        $navs = [
            ...
            '2' => ['url' => "$this->segment/$this->folder", 'name' => "แบนเนอร์โฆษณา", "last" => 1],
        ];
    ...
    {
        $like = $request->Like;
        $sTable = BannerAdsModel::orderby('id', 'desc') ->get();
    ...
    public function status_slide(Request $request)
    {
        try {
            $data = StatusSlideModel::find(1);
            $data->status_ads = $request->slide;
            $data->time_ads = $request->time;
    ...
    public function add(Request $request)
    {
        ...
        $navs = [
            ...
            '1' => ['url' => "$this->segment/$this->folder", 'name' => "แบนเนอร์โฆษณา", "last" => 0],
    ...
    public function store($request, $id = null)
    {
        try {
            ...
            if ($image) {
                ...
                $ext = explode("/", $lg->mime());
                $lg->resize(396, 191)->stream();
                
                $new = 'upload/banner/banner-ads' . date('dmY-Hism') . '.' . $ext[1];
    ...
    {
        $datas = BannerAdsModel::find($id);
        if (@$datas) {
            $query = BannerAdsModel::destroy($datas->id);
        }
