...
class TypeNewController extends Controller
{
    ...
    protected $controller = 'type-new';
    protected $folder = 'type-new';
    protected $menu_id = '6';
    protected $name_page = "ประเภทข่าว";
    ...
    public function index(Request $request)
    {
        ...
        $navs = [
            ...
            '1' => ['url' => "$this->segment/$this->folder", 'name' => "ประเภทข่าว", "last" => 1],
        ];
    ...
    {
        $like = $request->Like;
        $sTable = TypeNewModel::orderBy('id','desc')
    ...
    {
        $datas = TypeNewModel::find($id);
        if (@$datas) {
            $query = TypeNewModel::destroy($datas->id);
        }
